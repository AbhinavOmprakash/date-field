...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12870){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12871,G__12872,seq12870__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12891_SHARP_){
return (!((cljs.core.meta(p1__12891_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12917__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12918){var _e__12110__auto__ = e12918;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12924){var _e__12110__auto__ = e12924;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12932 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12933 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12933);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12935__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12932);
}});
...
var temp__5802__auto___12996 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12996)){
var managed_print_level_12997 = temp__5802__auto___12996;
var _STAR_print_level_STAR__orig_val__12942_12998 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12943_12999 = managed_print_level_12997;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12943_12999);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12939_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12939_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12942_12998);
}} else {
job_fn();
}
