...
return [(function (){var pred__23427 = cljs.core.instance_QMARK_;
var expr__23428 = reactive_val;
if(cljs.core.truth_((pred__23427.cljs$core$IFn$_invoke$arity$2 ? pred__23427.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__23428) : pred__23427.call(null,reagent.ratom.RAtom,expr__23428)))){
return "ra";
} else {
if(cljs.core.truth_((pred__23427.cljs$core$IFn$_invoke$arity$2 ? pred__23427.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__23428) : pred__23427.call(null,reagent.ratom.RCursor,expr__23428)))){
return "rc";
} else {
if(cljs.core.truth_((pred__23427.cljs$core$IFn$_invoke$arity$2 ? pred__23427.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__23428) : pred__23427.call(null,reagent.ratom.Reaction,expr__23428)))){
return "rx";
} else {
if(cljs.core.truth_((pred__23427.cljs$core$IFn$_invoke$arity$2 ? pred__23427.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__23428) : pred__23427.call(null,reagent.ratom.Track,expr__23428)))){
return "tr";
} else {
return "other";
}
