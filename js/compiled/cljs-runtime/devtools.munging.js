...
var o12535 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12535["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12536 = temp__5802__auto____$1;
return (o12536["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11997__auto__ = f;
return (o__11997__auto__["toString"]).call(o__11997__auto__);
} else {
return "";
}
...
try{var o__11997__auto___12789 = t;
(o__11997__auto___12789["cljs$lang$ctorPrWriter"]).call(o__11997__auto___12789,t,writer);
}catch (e12543){var __12790 = e12543;
}
...
var char_code = (function (){var o__11997__auto__ = (new String(char$));
return (o__11997__auto__["charCodeAt"]).call(o__11997__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11997__auto__ = String;
return (o__11997__auto__["fromCharCode"]).call(o__11997__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12553 = num_code;
switch (G__12553) {
case (1):
return (185);
...
var o__11997__auto__ = String;
return (o__11997__auto__["fromCharCode"]).call(o__11997__auto__,superscript_code);
});
/**
...
}catch (e12558){var _e__12110__auto__ = e12558;
return false;
}})())){
...
var vec__12559 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12559,(0),null);
...
var len__5769__auto___12817 = arguments.length;
var i__5770__auto___12818 = (0);
while(true){
if((i__5770__auto___12818 < len__5769__auto___12817)){
args__5775__auto__.push((arguments[i__5770__auto___12818]));

var G__12819 = (i__5770__auto___12818 + (1));
i__5770__auto___12818 = G__12819;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12568){
...
var vec__12586 = cljs.core.split_with((function (p1__12585_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12585_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(1),null);
...
var vec__12595 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12595,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12595,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12834 = cljs.core.rest(remaining_tokens);
var G__12835 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12834;
name_tokens = G__12835;
continue;
} else {
...
var vec__12602 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12602,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12602,(1),null);
var vec__12605 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12605,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12605,(1),null);
var vec__12608 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12608,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12608,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12608,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12608,(3),null);
...
var vec__12622 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12632 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12632,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12632,(1),null);
var vec__12638 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12638,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12638,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12647 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12647) : devtools.munging.parse_fn_info_deep.call(null,G__12647));
})()));
}
} else {
return fn_info;
...
var G__12851 = (arity + (1));
var G__12852 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12666){
var vec__12668 = p__12666;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12668,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12668,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12695_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12695_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12696_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12696_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___12865 = arguments.length;
var i__5770__auto___12866 = (0);
while(true){
if((i__5770__auto___12866 < len__5769__auto___12865)){
args__5775__auto__.push((arguments[i__5770__auto___12866]));

var G__12868 = (i__5770__auto___12866 + (1));
i__5770__auto___12866 = G__12868;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12699){
var vec__12700 = p__12699;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12700,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12697){
var G__12698 = cljs.core.first(seq12697);
var seq12697__$1 = cljs.core.next(seq12697);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12698,seq12697__$1);
}));
...
var map__12713 = options;
var map__12713__$1 = cljs.core.__destructure_map(map__12713);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12713__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12713__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12713__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12713__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12714 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12714,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12714,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12714,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12714,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12714,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12714,(5),null);
...
var o__11997__auto__ = f;
return (o__11997__auto__["getBasis"]).call(o__11997__auto__);
});
/**
...
}catch (e12721){var _e__12110__auto__ = e12721;
...
var G__12914 = (obj[cljs.core.first(path)]);
var G__12915 = cljs.core.rest(path);
obj = G__12914;
path = G__12915;
continue;
} else {
...
var _STAR_ = (function (accum,p__12729){
var vec__12730 = p__12729;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12730,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12730,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12742){
var vec__12743 = p__12742;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12743,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12743,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12743,(2),null);
...
var post_process = (function (p__12757){
var vec__12758 = p__12757;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12758,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12758,(1),null);
