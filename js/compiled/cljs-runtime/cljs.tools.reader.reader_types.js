...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14916 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14916(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14920 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14920(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14923 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14923(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14924 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14924(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14931 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14931(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14936 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14936(reader);
}
});
...
var G__15126 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__15127 = s.append(c);
c = G__15126;
s = G__15127;
continue;
}
