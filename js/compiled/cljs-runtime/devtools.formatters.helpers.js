...
var G__12846 = devtools.prefs.pref(v);
v = G__12846;
continue;
} else {
return v;
...
}catch (e12791){var _e__12110__auto__ = e12791;
return false;
}})();
...
}catch (e12801){var _e__12110__auto__ = e12801;
return false;
}})();
...
}catch (e12806){var _e__12110__auto__ = e12806;
return false;
}}
}
});
...
var vec__12824 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12824,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12824,(1),null);
...
return cljs.core.some((function (p1__12828_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12828_SHARP_);
}),template);
});
