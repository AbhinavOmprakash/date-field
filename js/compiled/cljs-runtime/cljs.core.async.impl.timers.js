...
var i_17382 = (0);
while(true){
if((i_17382 < arr.length)){
(arr[i_17382] = null);

var G__17383 = (i_17382 + (1));
i_17382 = G__17383;
continue;
} else {
}
...
var i_17392 = (self__.level + (1));
while(true){
if((i_17392 <= (new_level + (1)))){
(update[i_17392] = self__.header);

var G__17399 = (i_17392 + (1));
i_17392 = G__17399;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_17400 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17400[i]));
} else {
x__$2.forward.push((((i < links_17400.length))?(links_17400[i]):null));
}

if((i < links_17400.length)){
(links_17400[i] = x__$2);
} else {
links_17400.push(x__$2);
}
...
var i_17403 = (0);
while(true){
if((i_17403 <= self__.level)){
var links_17404 = (update[i_17403]).forward;
if((x__$1 === (((i_17403 < links_17404.length))?(links_17404[i_17403]):null))){
(links_17404[i_17403] = (x__$1.forward[i_17403]));

var G__17405 = (i_17403 + (1));
i_17403 = G__17405;
continue;
} else {
var G__17406 = (i_17403 + (1));
i_17403 = G__17406;
continue;
}
} else {
...
var G__17408 = nx;
var G__17409 = (level__$1 - (1));
x = G__17408;
level__$1 = G__17409;
continue;
} else {
var G__17410 = x;
var G__17411 = (level__$1 - (1));
x = G__17410;
level__$1 = G__17411;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__17415 = nx;
var G__17416 = (level__$1 - (1));
x = G__17415;
level__$1 = G__17416;
continue;
} else {
var G__17417 = x;
var G__17418 = (level__$1 - (1));
x = G__17417;
level__$1 = G__17418;
continue;
}
