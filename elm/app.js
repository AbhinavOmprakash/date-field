...
var $author$project$Main$EmptyForm = {$: 'EmptyForm'};
...
var $author$project$Main$isValidDateFormat = function (s) {
	return A2(
		$elm$regex$Regex$contains,
		A2(
			$elm$core$Maybe$withDefault,
			$elm$regex$Regex$never,
			$elm$regex$Regex$fromString('[\\d]{4}\\-[\\d]{2}\\-[\\d]{2}')),
		s);
};
...
var $author$project$Main$InvalidForm = {$: 'InvalidForm'};
var $author$project$Main$ValidForm = {$: 'ValidForm'};
var $author$project$Main$validateForm = function (model) {
	return (_Utils_eq(model.date.dateValidation, $author$project$Main$ValidDate) && _Utils_eq(model.dateRange.dateRangeValidation, $author$project$Main$ValidDateRange)) ? _Utils_update(
		model,
		{formValidation: $author$project$Main$ValidForm}) : ((_Utils_eq(model.date.dateValidation, $author$project$Main$EmptyDate) && _Utils_eq(model.dateRange.dateRangeValidation, $author$project$Main$EmptyDateRange)) ? _Utils_update(
		model,
		{formValidation: $author$project$Main$EmptyForm}) : _Utils_update(
		model,
		{formValidation: $author$project$Main$InvalidForm}));
};
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		return $author$project$Main$validateForm(newModel);
	});
...
var $author$project$Main$submitButton = function (isDisabled) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						!_Utils_eq(model.formValidation, $author$project$Main$ValidForm))
					]))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{
		init: {
			date: $author$project$Main$defaultDateField($author$project$Main$UpdateDate),
			dateRange: $author$project$Main$defaultDateRange,
			formValidation: $author$project$Main$EmptyForm
		},
